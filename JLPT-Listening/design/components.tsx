...
export interface BadgeItem { id: string; emoji: string; label: string; hint: string; unlocked: boolean; image?: ImageSourcePropType }
  ...
  return (
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm }}>
      {badges.map((b) => (
        ...
        >
          {b.unlocked && b.image ? (
            <Image source={b.image} style={{ width: 34, height: 34, borderRadius: 8 }} resizeMode="contain" />
          ) : (
